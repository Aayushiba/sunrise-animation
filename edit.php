...
<div>
  <button onclick="setTheme('Hanging House')">Hanging House</button>
  <button onclick="setTheme('Those Eyes')">Those Eyes</button>
  <button onclick="setTheme('Grave Secrets')">Grave Secrets</button>
